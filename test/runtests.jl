...
include("test_gravity_hydrostatic.jl")
include("test_tensor_anisotropy.jl")
include("test_tensor_rotated.jl")
include("test_wells_conservative.jl")
include("test_diph_steady_1d.jl")
